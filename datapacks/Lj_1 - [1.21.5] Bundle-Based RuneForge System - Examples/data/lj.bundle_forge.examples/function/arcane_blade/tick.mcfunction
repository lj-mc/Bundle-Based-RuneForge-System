...
execute if score @s lj.bundle_forge.examples.V.arcane_phase matches 4 run execute as @e[tag=lj.bundle_forge.examples.T_decapitate_victim] at @s anchored eyes positioned ^ ^ ^ run particle minecraft:dust{color:[1,0,0],scale:1} ~ ~ ~ 0.3 0.3 0.3 0 2
