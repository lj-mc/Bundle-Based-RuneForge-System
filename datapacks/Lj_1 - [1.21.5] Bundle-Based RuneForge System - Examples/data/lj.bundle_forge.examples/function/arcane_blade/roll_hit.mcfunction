tag @s remove lj.bundle_forge.examples.T_arcane_spin
scoreboard players add @s lj.bundle_forge.examples.V.arcane_phase 1
execute if predicate {condition:"minecraft:random_chance",chance:0.5} run tag @s add lj.bundle_forge.examples.T_arcane_spin
