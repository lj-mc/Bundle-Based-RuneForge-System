...
tag @a remove lj.bundle_forge.T.operating_player
tag @s add lj.bundle_forge.T.operating_player
$execute as @n[tag=lj.bundle_forge.T.armor_stand_op] run function $(func)
$item replace entity @s $(slot) from entity @n[tag=lj.bundle_forge.T.armor_stand_op] armor.head
